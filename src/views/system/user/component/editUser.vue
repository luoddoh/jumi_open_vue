				...
				<el-tab-pane label="基础信息" style="height: 550px">
					<el-form :model="state.ruleForm" ref="ruleFormRef" label-width="auto">
						<el-row :gutter="35">
							...
							<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
								<el-form-item label="角色集合" prop="roleIdList"
							...
							<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
								<el-form-item label="账号类型" prop="accountType"
									...
									<el-select v-model="state.ruleForm.accountType" placeholder="账号类型" collapse-tags
										collapse-tags-tooltip class="w100">
										<el-option label="系统管理员" :value="888"
											:disabled="userInfos.accountType != 888 && userInfos.accountType != 999" />
							...
							<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
								<el-form-item>
									<template #label>
										<el-text  type="danger">是否供应商</el-text>
									</template>
									<el-switch v-model="state.ruleForm.isinventory" inline-prompt active-text="是" inactive-text="否" />
								</el-form-item>
							</el-col>
							<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
								<el-form-item  prop="supplierId" :rules="state.ruleForm.isinventory?[{ required: true, message: '供应商不能为空', trigger: 'blur' }]:''">
									<template #label>
										<el-text  type="danger">供应商</el-text>
									</template>
									<el-select clearable filterable :disabled="!state.ruleForm.isinventory" v-model="state.ruleForm.supplierId" placeholder="请选择供应商">
							...
							<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
								<el-button icon="ele-Plus" type="primary" plain @click="addExtOrgRow"> 增加附属机构
								</el-button>
									...
									<el-row :gutter="35" v-for="(v, k) in state.ruleForm.extOrgIdList" :key="k">
										...
										<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
											<el-form-item label="职位" :prop="`extOrgIdList[${k}].posId`"
												...
												<el-select v-model="state.ruleForm.extOrgIdList[k].posId"
													placeholder="职位名称" class="w100">
													<el-option v-for="d in state.posData" :key="d.id" :label="d.name"
														:value="d.id" />
												</el-select>
											</el-form-item>
